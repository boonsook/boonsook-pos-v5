...
- Phase 628B Production Closeout docs(documents): **production smoke ใบเสนอราคา → ใบส่งสินค้า → ใบเสร็จ ผ่าน + cleanup** (docs only · build 628 / v5.69.95 ไม่ bump · local commit · รอ independent review)
  - PR #222 merged (`ec95993`) + deployed build 628 · owner-authorized, **Codex-operated** authenticated UI smoke 2026-09-24: INSERT/readback ของ `item_type` ผ่าน production app path ครบ 3 ตาราง (หัวข้อ + สินค้าคงชนิด/ลำดับ · ใบเสร็จ pending · ไม่รับชำระ/ไม่ post JV/ไม่แตะ stock) · cleanup RC → INV → QT ผ่าน (UI-observed ไม่ใช่ DB count)
  - ไม่แตะ runtime/SQL/payment/accounting/stock · residual "INSERT ยังไม่พิสูจน์" = SUPERSEDED · รายงาน [`PHASE-628B-PRODUCTION-SMOKE-CLOSEOUT.md`](PHASE-628B-PRODUCTION-SMOKE-CLOSEOUT.md) · STOP `READY-FOR-INDEPENDENT-PHASE-628B-CLOSEOUT-REVIEW`

...
- Phase 628A docs(documents): **owner SQL runbook** [`PHASE-628A-OWNER-SQL-RUNBOOK.md`](PHASE-628A-OWNER-SQL-RUNBOOK.md) (ปิด Should-fix จาก independent review · docs only · migration/test ไม่เปลี่ยน · build 626 / v5.69.93 ไม่ bump)
  ...
  - acceptance ของ B เทียบ fresh count ต่อ table — 136 / 111 / 95 (รวม 342) เป็น metadata snapshot ไม่ใช่ค่าตายตัว. SQL ยังไม่ apply · PostgreSQL parser/live execution: NOT RUN · Phase 628B ยังไม่เริ่ม. STOP รอ independent runbook review
- Phase 628A feat(documents): **schema foundation `item_type` (`item|heading`) ของรายการเอกสาร 3 ตาราง — SQL owner-run ยังไม่ apply** (build 626 / v5.69.93 ไม่ bump · schema + tests + docs เท่านั้น)
  ...
  - **PostgreSQL parser/live execution: NOT RUN** — owner รันหลัง independent review; ยังไม่ live. ไม่แตะ runtime/UI/เงิน/สต็อก/RLS/markers. **Phase 628B (runtime/totals/conversion/rendering) ยังไม่เริ่ม**. STOP รอ independent review

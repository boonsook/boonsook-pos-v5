...
const ROLE_PAGES = {
  admin:      ALL_ROUTES,
  technician: ["dashboard","pos","service_jobs","calendar","btu_calculator","solar","ac_install","error_codes","error_codes_fridge","error_codes_washer","ai_sales","ac_shop", ...SERVICE_FORM_ROUTES],

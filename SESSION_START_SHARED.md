...
- 🆕 build 415 = ob-form-dynamic-bank-fields (**ACCOUNTING §4.3 · form-only**): ฟอร์ม "ลงยอดยกมา" ดึงช่องเงินฝากธนาคารจาก chart_of_accounts จริงแบบ dynamic (เดิม hardcode 1130/1140 — กรอกแยก 6 บัญชีใหม่ 1131–1136 ไม่ได้): `fetchBankAssetAccounts()` filter type=asset · code 4 หลัก 1130–1199 · is_active · เฉพาะ leaf (header ที่มีลูกชี้มาไม่เอา) · เรียง sort_order; render → async, ASSET = 1110/1120 + banks dynamic + 1200/1300 ใน `_assetFields` (calc/submit/reset loop จาก list นี้); fetch ล้ม → fallback 1130/1140 + แถบเตือน (ไม่ crash). ❌ ไม่แตะ EQUITY/LIABILITY + App.confirm (414) · save semantics · effective_date.js · COA data/SQL. +guard opening_balance_guard 6→12 (behavioral 3 + regex 3) · lint 0 / unit 1455 / e2e 12. คาดหวัง: ช่องธนาคาร 8 ช่อง (1130,1131–1136,1140).

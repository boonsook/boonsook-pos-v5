...
- Main app version: `5.66.0` (build 420 บน branch `claude/phase-420-hr-forms`; origin/main = build 419 live `f4ab6a1` (mobile drafts + service cancel fix + playwright webserver timeout)) · ⏸️ STOP — รอ owner review + **รัน supabase-phase420-hr-forms.sql ก่อน smoke** + preview ก่อน merge

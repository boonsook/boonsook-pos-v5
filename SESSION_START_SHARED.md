...
Last updated: 2026-06-12 (Phase 424 workspace-wash + 425 sidebar-reorganization — ✅ **merged ff `01f3c09` = build 425 live** · owner ดู preview แล้วสั่ง merge · live HTML verified data-app-build=425 + nav groups; ก่อนหน้า: 421-423 ui-redesign live `f9bfcc0`) · เริ่มบัญชีจริง 1 ก.ค. 2569 (ก่อนนั้น = test, ไม่ post JV)
...
- Main app version: `5.66.0` (**build 425 live บน origin/main** — ui-polish ชุดสอง 424 bg-wash + 425 sidebar-reorg merged ff `01f3c09` 2026-06-12 · owner ดู preview แล้วสั่ง merge · live verified data-app-build=425; ชุดแรก 421-423 = `f9bfcc0`; smoke checklist เต็มบน live = ค้างให้ owner ยืนยันทั้งสองชุด)

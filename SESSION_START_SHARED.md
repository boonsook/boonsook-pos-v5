...
Last updated: 2026-06-12 (Phase 421+422+423 ui-redesign ครบชุด — ✅ **merged ff `f9bfcc0` = build 423 live** · owner ดู preview แล้วสั่ง merge (smoke checklist เต็มบน live ยังไม่ได้รายงาน) · live HTML verified data-app-build=423) · เริ่มบัญชีจริง 1 ก.ค. 2569 (ก่อนนั้น = test, ไม่ post JV)
...
- Main app version: `5.66.0` (**build 423 live บน origin/main** — ชุด ui-redesign 421 skin + 422 dashboard layout + 423 finishing merged ff `f9bfcc0` 2026-06-12 · owner ดู preview + อนุมัติ merge; smoke checklist เต็มบน live = ค้างให้ owner ยืนยัน · live verified data-app-build=423)

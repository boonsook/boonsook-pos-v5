...
Last updated: 2026-06-12 (Phase 424 workspace-wash + 425 sidebar-reorganization — **build 425** บน branch `claude/phase-424-bg-tint` · ⏸️ STOP รอ owner ดู preview + สั่ง merge ทีเดียว; origin/main = **build 423 live** (ui-redesign 421-423 merged ff `f9bfcc0` + stamp `f898614`)) · เริ่มบัญชีจริง 1 ก.ค. 2569 (ก่อนนั้น = test, ไม่ post JV)
...
- Main app version: `5.66.0` (**build 423 live บน origin/main**; build 424 บน branch `claude/phase-424-bg-tint` ⏸️ รอ owner ดู preview + merge — ชุด ui-redesign 421-423 merged ff `f9bfcc0` 2026-06-12 · owner ดู preview + อนุมัติ merge; smoke checklist เต็มบน live = ค้างให้ owner ยืนยัน)

...
export function renderDeliveryInvoicesPage(ctx) {
  ...
  container.innerHTML = `
    <div class="panel">
      ...
      <div class="di-tabs" style="display:flex;gap:6px;margin-top:4px;border-bottom:2px solid #e2e8f0;overflow-x:auto">
        ${[

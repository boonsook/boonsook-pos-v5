...
**อัปเดตล่าสุด:** 7 มิถุนายน 2026 (Phase 397 dashboard-recent-txn — build 397, display · read-only) · เพิ่มบล็อก "🧾 ธุรกรรมล่าสุด" บนหน้า dashboard (ตารางรายการขายล่าสุด ≤30 + scroll) · ⏳ branch push รอ Codex review + owner smoke ก่อน merge/deploy

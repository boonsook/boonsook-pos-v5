...
**Status: ⚠️ branch `claude/phase-517b-3-credit-ui-jv-2180-split` (build 521 + B1 fix) — รอ owner preview smoke + review + merge. 🎉 ปิด Phase 517 ครบ (517a→517b-3) หลัง merge. owner smoke: วันที่ < 1 ก.ค. → ช่อง "ใช้เครดิต" ไม่โผล่ + ขายปกติได้.**

...
**อัปเดตล่าสุด:** 7 มิถุนายน 2026 (Phase 393 service-request-total-cost-notnull-hotfix — build 393, HIGH service blocked) · ต้นเหตุจริงของ "งานช่างหลุดคิว" (Phase 391 ทำให้ error โผล่แทน success ปลอม): service_jobs.total_cost NOT NULL แต่ service_request POST ไม่มี total_cost → null → save ล้ม → ไม่เข้า DB/คิว · ⏳ branch push รอ Codex review + owner re-smoke ก่อน merge/deploy

...
**อัปเดตล่าสุด:** 7 มิถุนายน 2026 (Phase 397 dashboard-recent-txn — build 397, display · read-only) · เพิ่มบล็อก "🧾 ธุรกรรมล่าสุด" บนหน้า dashboard (ตารางรายการขายล่าสุด ≤30 + scroll) · ✅ **reviewed + merged ff → main (9ec6bda)** · CI Tests+Deploy success · **live build 397 verified** + **deployed feature confirmed live** (dashboard.js _recentTxnRows + "ธุรกรรมล่าสุด") · ⏳ owner manual smoke (#dashboard → ตาราง+scroll) · **MERGED/LIVE**

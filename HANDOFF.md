...
**อัปเดตล่าสุด:** 6 มิถุนายน 2026 (Phase 383 service-job-status-db-safe-hotfix — build 383) · ✅ **Codex APPROVED + merged ff → main** (CI Tests+Deploy success; live build 383 verified) · **HIGH hotfix** · รอ owner manual smoke

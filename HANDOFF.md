...
**อัปเดตล่าสุด:** 7 มิถุนายน 2026 (Phase 390 accounting-readiness-service-scope-fix — build 390, HIGH money-path visibility) · ✅ **Codex APPROVED for final stage** · รวมรายได้งานบริการเข้า close-readiness + Backfill integrity (กันงวด/บัญชีเขียวลวงทั้งที่ service JE หาย) · ⏳ deploy + owner manual smoke
